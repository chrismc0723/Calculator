...
# name of the top of the gui
root.title("Scientific Calculator")

# Setting the background colour as white
root.configure(background='white')

# Set the width and height of the gui so it can't be stretched or expanded
root.resizable(width=False, height=False)

# Set the geometry
root.geometry("480x568+450+90")

# Keeps the buttons within the calculator,
calc = Frame(root)

# create a grid like pattern of the frame, buttons
calc.grid()
...
txtDisplay = Entry(calc, font=('Helvetica', 20, 'bold'),
                   bg='black', fg='white', bd=30, width=28,
                   justify=RIGHT)
...
# Store the numbers for the calculator
numberpad = "789456123"

# Now I will count the rows for placing buttons within the grid
i = 0

# Create an empty list to store each individual button
btn = []

# j is in that range to place the button in a specific row
for j in range(2, 5):

    # k is in range to place the button in a specific column
    for k in range(3):
        btn.append(Button(calc, width=6, height=2, bg='black',
                          fg='white', font=('Helvetica', 20, 'bold'),
                          bd=4, text=numberpad[i]))

        # Set the buttons in row & column and separate them with padding
...
# use the askyesno function to stop/continue the program execution
def iExit():
